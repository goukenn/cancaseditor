...
function CanvasVisitor(){
	this.msrc = "";
};

igk.appendProperties(CanvasVisitor.prototype, {
...
var Key = ACTIONS.Key;
ACTIONS.regMenuAction("file.export.toCanvasExpression", {index:10, callback:function(a){
	a.exportTo("canvas");
}});
