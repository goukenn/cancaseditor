...
var _moodule = igk.system.module("com.igkdev.canvaseditor");
var m_initlib = 0;
...
function CanvasPrimitive(m_ctx){
	// - CanvasPrivimitive encapsuler  
...
function CanvasEditorApp(q, o){
	...
	this.initContext = function(type){
		...
		//
		CanvasPrimitive.apply(this, [m_ctx]);
	...
	var drawingLayeredObject  = function(){
		...
		var m_blendings = 0;
		 ...
		 function getApp(){
			 ...
			 // return null;
			 while( q){ 
				 if (q.__proto__.constructor.name == "CanvasEditorApp"){
					 break;
				 }
				 q = q["@container"];
			 }
...
(function(){
	...
	function(a){
		...
		var _title	= (a.document? a.document.title :null) || 'CanvasEditorProject';
